...
[← 目次](./TOC.md) | [前: 共通の前提](./index.md) | [次: Day1](./Day01_Ethereum_Intro.md)
...
- Hardhat/Foundry を使って、ローカルでテストを回せる状態になる。

## このPartで扱わないこと（先に宣言）
- いきなりMainnetでTxを投げる（まずはローカル/テストネットで検証する）。
- いきなり複雑な DApp を作る（まずはコントラクトとテストの基礎を固める）。

## 最短ルート（迷ったらここだけ）
1) 共通の前提を読む：[`docs/curriculum/index.md`](./index.md)  
