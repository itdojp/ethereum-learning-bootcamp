...
### 2.5 迷ったときの選び方
- Solidity の文法やテストがまだ不安: Day01〜Day06 を優先する
- 画面から触れる成果物を早く見たい: Day09 と Day14 を優先し、DApp 接続を先に通す
- Explorer で確認できる状態まで持っていきたい: Day07 を先に読み、Verify の付録を横に置く
- 「どこまでできれば完了か」を明確にしたい: Day14 のチェックリストを先に読み、必要な提出物を逆算する
