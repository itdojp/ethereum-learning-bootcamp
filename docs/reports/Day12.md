...
- Foundry invariant：`test/Invariant.t.sol`で、3 actorの内部台帳合計・contract assets・ghost net depositsの一致をstatefulに検査。`test-negative/UnsafeAccountingInvariant.t.sol`の1 wei mutationが同じpropertyを破ることも自動確認。
