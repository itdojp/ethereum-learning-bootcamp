...
## 2026.07
- Hardhat 2 toolchainをHardhat 3.11.0、Node.js 22.13.0以上、明示plugin/network connectionへ移行し、組み込みcoverage/gas statistics、install-script policy、high/critical 0のaudit gateを追加
